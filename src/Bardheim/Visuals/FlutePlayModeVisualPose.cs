...
{
    private static readonly HashSet<FlutePlayModeVisualPose> Instances = new();
    private static readonly Vector3 DefaultCarryLocalPosition = new Vector3(0.03f, 0.03f, 0.08f);
    private static readonly Vector3 DefaultCarryLocalEuler = new Vector3(0.0f, -70.0f, 90.0f);
    ...
    {
        if (!enabled || activeInstrumentId != InstrumentCatalog.FluteId)
        {
            return;
        }
    ...
    private bool CanApplyPose()
    {
        return gameObject.activeInHierarchy &&
               ...
               !transform.root.name.Equals(FluteItemRegistration.PrefabName, StringComparison.Ordinal);
    }
